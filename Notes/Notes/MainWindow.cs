...
namespace MillionDollarNoteApp
{
    ...
    {
        SQLiteWrapper api = new SQLiteWrapper("notes_database");
        ...
        public Notes()
        {
            ...
            api.createTable("notes", cols_template);
        ...
        private DataTable loadData()
        {
            ...
            List<Dictionary<string, string>> shits = api.getData("notes", cols);
